              ...
              <tbody>
                <tr class=" tableRow
                  ...
                  <td class="flex flex-row py-1 max-w-3">
                    ...
                    <Link :href="'/reporting/view/' + spoof.id2" class="w-16 py-1 mx-auto transition-all duration-150 ease-linear tableButton tableButton2 visited:bg-pink-300 active:bg-yellow-200 hover:bg-yellow-200 focus:outline-none" preserve-scroll>
