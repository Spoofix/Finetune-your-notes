  ...
  <AuthenticatedLayout class="overflow-scroll " style="height: 100vh;">
    <section class="py-1 pt-6 bg-blueGray-50">
      ...
      <div class="lg:mr-7" v-for="(domain, index) in domainList" :key="index">
        ...
        <div v-if="showTable && index === indexStore" class="items-center overflow-auto bg-transparent border-collapse lg:ml-6 md:ml-4 smooth" :class="{ 'smoothDropDown': showTable }" id="smoothDropDown">
          <div class="overflow-x-auto ">
            ...
            <div class="bg-white" style="width: 100%; height: 330px" v-if="paginatedSpoofList.length === 0">
              <div class="mx-auto ">
                <h1 class="pt-6 text-center max-w-60 h6">No spoofing site takedown currently completed for domain "{{domain.domain_name }}". <br>We'll update completed takedown's here if any! If you have any questions or need further assistance, feel free to reach out.<br> Your satisfaction is our priority.</h1>
