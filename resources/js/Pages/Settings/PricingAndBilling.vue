...
<template>
  ...
  <SettingsLayout class="overflow-scroll fontFamily" style="height:100vh; background: #FFF;"> <!-- v-if=" props.userid === userId" -->
    ...
    <div v-else>
      ...
      <div class="flex items-center justify-between mx-3 my-2 mr-3 h-14" v-if="activeOne === 'Pricing'">

        <div class="flex items-center justify-between my-2 cursor-pointer lg:mx-3 sm:mx-2 sm:mr-4 bigDropdownBg h-14 w-100" style="border-radius: 6px; " id="myDiv">
