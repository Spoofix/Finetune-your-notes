...
<template>
    <div>
        <div id="page-container" class="sidebar-o enable-page-overlay side-scroll page-header-fixed main-content-narrow"> 
         ...
         <!-- sidebar was here -->
         <div class="relative">
          <nav class="absolute top-0 bottom-0 left-0 flex w-64 px-2 py-2 transition-all duration-300 ease-in-out transform -translate-x-full shadow-xl bg-blue flex-nowrap md:z-10 z-9999 md:translate-x-0"  style="background: var(--dark-neutral-dark-neutral-10, #262626); width:300px;" id="sidebar">
              ...
              <div class="content-header justify-content-lg-between">
                ...
                <div>
                   <div class="justify-between w-full d-flex" >
                    <!-- Logo -->
                    <Link class="logo-div" :href="route('dashboard')">
                  ...
                  <ul class="nav-main ">
                    <li class="pl-4 nav-main-items">
                      <Link class="nav-main-link" :href="route('dashboard')" @click="active('Scanned')">
                        ...
                        <span class="nav-main-link-name sidenav_text">Dashboard</span>
                      </Link>
                    </li>
                    <li class="pl-4 nav-main-item">
                      <Link class="nav-main-link" :href="route('domains')"  @click="active('Scanned')">
                         <i class="justify-center pt-1 my-2 text-xl text-black rounded h-9 align-center w-9 nav-main-link-icon fa fa-server nav-icons-background" :class="{ 'active-bg': active('Scanned') === 'Scanned' }"></i>
                        <span class="nav-main-link-name sidenav_text" :class="{ 'active-text': active('Scanned') === 'Scanned' }">Scanned</span>
                      </Link>
                    </li>
                    <li class="pl-4 nav-main-item">
                      <Link class="nav-main-link" :href="route('domains')" @click="active('Scanned')">
                        ...
                        <span class="nav-main-link-name sidenav_text">Report Form</span>
                      </Link>
                    </li>
                       <li class="pl-4 nav-main-item">
                      <Link class="nav-main-link" :href="route('domains')" @click="active('Scanned')">
                        ...
                        <span class="nav-main-link-name sidenav_text">In Progress</span>
                      </Link>
                    </li>
                       <li class="pl-4 nav-main-item">
                      <Link class="nav-main-link" :href="route('domains')">
                        ...
                        <span class="nav-main-link-name sidenav_text">Completed</span>
                      </Link>
                    </li>
                       <li class="pl-4 nav-main-item ">
                      <Link class="nav-main-link" :href="route('domains')">
                        ...
                        <span class="nav-main-link-name sidenav_text">Messages</span>
                      </Link>
                    </li>
                    <li class="nav-main-item" v-if="$page.props.auth.user.role_id == 1">
                      <Link class="nav-main-link" :href="route('users.list')">
                        ...
                        <span class="nav-main-link-name sidenav_text">Users</span>
                      </Link>
                    </li>
                  <li class="pl-4 nav-main-item">
                      <Link class="nav-main-link" :href="route('domains')">
                        ...
                        <span class="nav-main-link-name sidenav_text">Help Center</span>
                      </Link>
                    </li>
                     <li class="pl-4 nav-main-item">
                      <Link class="nav-main-link" :href="route('domains')">
                        ...
                        <span class="nav-main-link-name sidenav_text">Feedback</span>
                      </Link>
                    </li>
