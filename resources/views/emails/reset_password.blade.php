...
<body>
    ...
    <div class="container ">
        ...
        <div class="content">
            ...
            <p style="color: #000; text-align: center;">Seems like you forgot your password for Spoofix. If this is true, click below to reset your password.</p>
           
            <div style="height: 20px;"></div>
            <div style="margin: auto; width:fit-content;">
                <a class="button" href="http://127.0.0.1:8000/profile-change-password">Reset Password</a>
            </div>
            <div style="height: 40px;"></div>
            <p>If this email is not intended to you please ignore and delete it. Thank you for understanding.</p>
    
        </div>
        <div style="margin-top: 30px; padding: 20px;">For further assistance , please contact our customer service center:
            <a href="http://127.0.0.1:8000/profile-change-password" style="color: #4285F4; text-decoration: none;">support@spoofixcustomercare.com</a>
        </div>
