...
<body>
    ...
    <div class="container ">
        ...
        <div class="content">
            <div class="heading">Welcome to Spoofix</div>
            <p style="color: #000;">Hi {{user->name}},</p>
            ...
            <p>Thanks for joining our mission against online spoofing. Report any suspicious sites and stay updated with our community.</p>
            <p>Best,</p>
            <p>Spoofix team</p>
        </div>
        <div style="margin-top: 10px; padding: 20px;">For further assistance , please contact our customer service
            center:
