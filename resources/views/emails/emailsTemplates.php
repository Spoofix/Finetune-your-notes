...
<body>
    ...
    <div class="container ">
        ...
        <div class="content">
            <div class="heading">{{}} DOMAINS FOUND</div>
            <p style="color: #000;">We have detected {{}} domains that are potential spoofing sites for your domain {{}}.</p>
               <p>Please review the list of detected domains carefully and let us know if you have any concerns or questions:</p>
        
            <div style="height: 20px;"></div>
            <div style="margin: auto; width:fit-content;">
                <a href="https://uat.spoofix.com/domains" class="no-underline"><div class="button" >view</div></a>
            </div>
            <div style="height: 40px;"></div>
            <p>If this email is not intended for you, please ignore and delete it. Thank you for understanding.</p>
        </div>
        <div style="margin-top: 10px; padding: 10px;">For further assistance, please contact our customer service center:
